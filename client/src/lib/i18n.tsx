...
const translations: Record<string, Record<Language, string>> = {
  ...
  hero_metric_downloads: { ru: "загрузок", en: "downloads" },
  ...
  about_item1_1: { ru: "Руковожу SDK и агентной платформой для GigaChat: более 1M загрузок, top 1.5% PyPI.", en: "Lead the SDK and agent platform for GigaChat: 1M+ downloads, top 1.5% on PyPI." },
